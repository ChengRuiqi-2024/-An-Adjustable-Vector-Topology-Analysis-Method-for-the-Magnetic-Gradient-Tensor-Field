...
arguments
    ...
    opts.radialCosThreshold (1,1) double = 0.15
    opts.minConsistentFraction (1,1) double = 0.78
    opts.indexTolerance (1,1) double = 0.38
    opts.maxDirectionStep (1,1) double = 0.925*pi
