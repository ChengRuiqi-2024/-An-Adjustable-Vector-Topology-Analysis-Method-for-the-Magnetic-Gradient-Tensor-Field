...
s1=scatter(sum_source_XY(:,1),sum_source_XY(:,2),100,'k','filled');
hold on
s2=scatter(sum_sink_XY(:,1),sum_sink_XY(:,2),100,'s','k','filled');
hold on
s3=scatter(sum_saddle_XY(:,1),sum_saddle_XY(:,2),200,'p','k','filled');
xlim([-21 21])
ylim([-21 21])
...
hold on
fin5=scatter(source_remove(:,1),source_remove(:,2),100,'k','filled');
hold on
fin6=scatter(sink_remove(:,1),sink_remove(:,2),100,'s','k','filled');
hold on
fin7=scatter(saddle_remove(:,1),saddle_remove(:,2),200,'p','k','filled');
